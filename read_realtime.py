...
from read_skew import order_points, find_board,  four_point_transform, recog_by_warped,read_sudoku_from_cnt
    ...
    if board_cnt is not None:
        ...
        if recognize:
            try:
                ...
                last_sudoku = recog_by_warped(read_sudoku_from_cnt(frame,board_cnt))
